...
exports.DEFAULT_DEPOT = exports.COLOMBIAN_CITIES_COORDS = exports.geoRouter = void 0;
exports.calculateHaversineKm = calculateHaversineKm;
const express_1 = require("express");
const db_1 = require("../../database/db");
const auth_middleware_1 = require("../../middlewares/auth.middleware");
exports.geoRouter = (0, express_1.Router)();
exports.geoRouter.use(auth_middleware_1.authMiddleware);
exports.COLOMBIAN_CITIES_COORDS = {
...
exports.geoRouter.get('/geocode', async (req, res) => {
    try {
        ...
        const cityFallback = exports.COLOMBIAN_CITIES_COORDS[cityKey] || exports.DEFAULT_DEPOT;
        let geoResult = null;
        if (address) {
            try {
...
exports.geoRouter.post('/deliveries-locations', async (req, res) => {
    try {
    ...
    `, params);
        ...
        for (const d of rows) {
            ...
            if (!lat || !lng) {
                ...
                const base = exports.COLOMBIAN_CITIES_COORDS[cityKey] || exports.DEFAULT_DEPOT;
                let hash = 0;
                ...
                try {
                    await (0, db_1.queryRun)(`UPDATE deliveries SET latitude = ?, longitude = ?, geocoded_at = NOW() WHERE id = ?`, [lat, lng, d.id]);
                }
                catch (uErr) {
                    console.warn('Aviso al guardar coordenadas:', uErr);
                }
            }
        ...
        res.json({ success: true, depot: exports.DEFAULT_DEPOT, locations: resultLocations });
    }
    catch (error) {
...
exports.geoRouter.post('/route-plan', async (req, res) => {
    try {
        ...
        const startPoint = { lat: origin?.latitude || exports.DEFAULT_DEPOT.lat, lng: origin?.longitude || exports.DEFAULT_DEPOT.lng, label: origin?.label || 'Punto de Partida' };
        const placeholders = delivery_ids.map(() => '?').join(',');
