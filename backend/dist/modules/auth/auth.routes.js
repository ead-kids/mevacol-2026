...
exports.authRouter.post('/bootstrap', async (req, res) => {
    try {
        const adminCheck = await (0, db_1.queryOne)(`
    ...
    `);
        ...
        await (0, db_1.queryRun)(`INSERT INTO users (id, username, full_name, email, password_hash, role_code, phone, is_active, created_at, updated_at)
